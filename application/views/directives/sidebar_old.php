    ...
    <div class="tab_container">
      ...
      <section id="content1" class="tab-content clearfix">
        ...
        <div ng-init="ShowHideAng(0)" class="cd-accordion animated" ng-show="sessionusetype==0">
          <h4 class="accordionCls main-spr game-ic" ng-class="{true:'flipImg',false:'active'}[accordion==-1]"  ng-show="accordion==-1 || accordion==0">
            <a href="" ng-click="ShowHideAng(-1)" ui-sref="dashboard.Home">Application Settings</a>
          </h4>
          <ul class="accordion-content sub-item game-ic main-ul-scroll" ng-show="accordion==-1">
            ...
            <li ui-sref-active="active">
              <a ui-sref="dashboard.uploadImg">Set Pictures</a>
            </li>
      <li ui-sref-active="active">
      ...
      <li ui-sref-active="active">
          ...
          <h4 class="accordionCls main-spr {{getCssVal(displyData.id)}}" ng-class="{true:'flipImg',false:'active'}[accordion==displyData.id]" ng-repeat="displyData in sprtData" ng-show=" accordion==0 || accordion==displyData.id">
            <a href="" ng-click="ShowHideAng(displyData.id,0)"  ui-sref="dashboard.Getseriesfrmapi({sportId: displyData.id})" ng-show="displyData.id != 7">
              {{displyData.name}}
            </a>
            <a href="" ng-click="ShowHideAng(displyData.id,0)"  ui-sref="dashboard.Getmatchfrmapi({seriesId: match.seriesId,sportId:displyData.id})" ng-show="displyData.id == 7">
              {{displyData.name}}
            </a> 
            <!--Series-->
                          ...
                          <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in inPlay" ng-show="accordionLv1==0 || accordionLv1==series.MstCode">
                            ...
                            <ul class="accordion-content " ng-show="accordionLv1==series.MstCode">
                              <li ng-repeat="market in MatchMarket" class="market_type"  ui-sref-active="active">                            
                                ...
                                <a ng-if="displyData.id!=4"  href="" class="match-od-link" ui-sref="dashboard.Matchodds_user({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})" >
                                  {{market.Name}}
                                </a>
                              </li> 
        ...
        <!--User SideBar Sports-->
        <h4 class="accordionCls main-spr {{getCssVal(displyData.id)}}" ng-class="{true:'flipImg',false:'active'}[accordion==displyData.id]" ng-repeat="displyData in sprtData" ng-show="(accordion==0 || accordion==displyData.id) && sessionusetype!=0" ng-if="displyData.id != 7">
          ...
          <ul class="accordion-content main-ul-scroll" ng-show="accordion==displyData.id">
            <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in GetMatchData" ng-show="accordionLv1==0 || accordionLv1==series.MstCode" ui-sref-active="active">
              ...
              <ul class="accordion-content " ng-show="accordionLv1==series.MstCode">
                <li ng-repeat="market in MatchMarket" class="market_type"  ui-sref-active="active">
                    <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;"  ng-if="market.IsPlay==0" ng-show="sessionusetype!=3" href="" ng-class="{true:'play comm-play',false:'pause comm-play'}[chkMarketPP]" ng-click="sdMarketPP(displyData.id,series.MstCode,market.Id,0,market.IsPlayIcon)" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})">
                    </a>
                    <div ng-if="displyData.id == 4">
                      <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;"  ng-if="market.IsPlay==0" ng-show="sessionusetype==3" href="" ng-class="{true:'play comm-play',false:'pause comm-play'}[chkMarketPP]" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})">
                      </a>
                      <a  ng-if="market.IsPlay==0" href="" class="match-od-link" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})">{{market.Name}}</a>
                    </div>
                    <div ng-if="displyData.id != 4">
                      <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;"  ng-if="market.IsPlay==0" ng-show="sessionusetype==3" href="" ng-class="{true:'play comm-play',false:'pause comm-play'}[chkMarketPP]" ui-sref="dashboard.Matchodds_user({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})">
                      </a>
                      <a  ng-if="market.IsPlay==0" href="" class="match-od-link" ui-sref="dashboard.Matchodds_user({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate})">{{market.Name}}</a>
                    </div>
