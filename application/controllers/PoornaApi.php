...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class PoornaApi extends CI_Controller {

		public $APP_KEY = "JHhVoGflnrBafnkc";

		//public $APP_KEY = "WaIiEmhVft0FXzxr";
		//public $APP_KEY = "sifRr3FO1b0G7DV5";
		...
		function getBackLaysOfMarket($MarketId=null){//170201
		...
		function getBackLaysOfMarketSelectionName($MarketId=null)//sourabh 161226 change
 ...
 $sessionToken=$this->getTokenId();
		...
		function GetOddsAPi(){
			...
			ob_start();
				...
				curl_setopt($ch, CURLOPT_URL, "http://satyamitsolution.com/api/api.php");
		...
		function matchMatchFancy(){//sourbh 170103 new
           ...
           }	   function getSeries1($appKey ,$horseRacingEventId)//sourabh 9-dec-2016
	{ 
		//echo $sessionToken;
		$params = '{"filter":{"eventTypeIds":["'.$horseRacingEventId.'"]}} ';
		$jsonResponse = $this->sportsApingRequest($appKey,'ijpaqdSavKqhTQakZnYjz+mozxjFG+PUjqujq3oa6Dc=','listCompetitions', $params);
		return $jsonResponse;	
	}
